...
def parse_args():
    ...
    p.add_argument("--csv", default="data/dataset_sample.csv", help="Path to CSV (default: data/dataset_sample.csv)")
...
def main():
    ...
    if not os.path.exists(args.csv):
        raise SystemExit(f"CSV not found: {args.csv}. Create or copy dataset_sample.csv next to this script.")
